...
class Draggable{
    ...
    this.isMobile = window.mobileCheck();
    	this.moveAction = this.isMobile ?  "touchmove" : "mousemove";
...
document.body.style.overflow = "";
    ...
    onMouseMove(e){
     const target = this.target;
            const pose = {
                x:this.isMobile ? e.touches[0].clientX :  e.clientX,
                y:this.isMobile ? e.touches[0].clientY : e.clientY
            }
              ...
              Array.from(document.querySelectorAll(this.selector)).forEach(el => {
                ...
                el.addEventListener(this.downAction, (e) => {
                    ...
                    this.target.style.zIndex = this.Zindex;
                       ...
                       window.addEventListener(this.moveAction, this.onMouseMove);
                        }
